...
mongoose.connect("mongodb+srv://"+process.env.MDBUSERNAME+":"+process.env.MDBPASSWORD+"@cluster0.tuathop.mongodb.net/dentalDB?retryWrites=true&w=majority", {useNewUrlParser:true});
